...
<div class="container-fluid category">
    <div class="row">
        <div class="col-lg-4 col-md-4 col-sm-12 mx-auto form">
            <h2 class="category-title">Edit Game Category</h2>
            <form action="{{route('updateCategory')}}" method="POST">
                @CSRF
                @foreach($categories as $category)
                <div class="form-group">
                    <input type="text" class="form-control" id="categoryName" name="categoryName" placeholder="New Game category" value="{{$category->name}}">
